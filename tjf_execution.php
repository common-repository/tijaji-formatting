...
$tjf_tag = 'div|center|fieldset|blockquote|form|label|input|option|select|noscript|h1|h2|h3|h4|h5|h6|address|p|ul|ol|li|dl|dt|dd|dir|menu|table|tbody|thead|tr|th|td|isindex|noframes';
$tjf_inline_tag = 'style|script|object|applet|button|textarea|option|map|area|pre|ins';
